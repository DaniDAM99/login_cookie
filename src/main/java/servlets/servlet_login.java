...
public class servlet_login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            if(usuario.equals("admin") && pwd.equals("1234")) {
                Cookie c = new Cookie("usuario_logeado", "admin");
                c.setMaxAge(60);
                response.addCookie(c);
                out.println("<p style='color: green;'>Logeado correctamente</p>");
                out.println("<a href='servletPrincipal'>Servlet principal</a>");
            }
            else {
                out.println("<p style='color: red;'>Error al iniciar sesion</p>");
